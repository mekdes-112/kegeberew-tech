...
const Kccsm = () => {
  ...
  const images = [
    ...
    '../../assets/img/kot8.jpg',
    '../../assets/img/kot9.jpg',
    '../../assets/img/kot10.jpg',
    '../../assets/img/kot11.jpg',
  ...
  <div className="container-fluid position-relative p-0">
    ...
    <div
        className="container-fluid bg-primary py-5 bg-headertwo"
  ...
  <div className="container">
    <div className="row">
      <div className="col-md-6">
        ...
        alt="..."
        style={{ height: 400, width: 50, cursor: 'pointer' }}
...
{isOpen && (
      ...
      <div className="col-md-6">
        <div className="_product-detail-content">
          ...
          Kegeberew Order Tracking Platform
          </p>
          ...
          <div className="_p-features">
            ...
            <p>
            Kegeberew Order Tracking platform is essential tool for Ecommerce businesses in order to ensure the service excellency and customer satisfaction.  It helps to track and notify order status on each processing stages till delivered successfully.  It is also very handful platform for control, management and decision making </p>
          </div>
